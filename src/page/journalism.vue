<!--
 * @Author: fauchard
 * @Date: 2021-12-08 09:16:43
 * @LastEditTime: 2021-12-20 10:47:23
 * @LastEditors: Please set LastEditors
 * @Description: 打开koroFileHeader查看配置 进行设置: https://github.com/OBKoro1/koro1FileHeader/wiki/%E9%85%8D%E7%BD%AE
 * @FilePath: \sw_vue\src\page\dynews.vue
-->
...
<template>
  <div>
      <!-- 导航栏 -->
    <navbar></navbar>
    <div class="container" style="position: relative; top: 10px;height:40%" >
      <b-img
        src="https://s4.ax1x.com/2021/12/08/oRInYV.jpg"
        fluid
...
import Dmf from '../components/Dmf.vue'
import Navbar from '../components/Navbar.vue'
export default {
  name: "News",
  components: { Navbar, Dmf },
